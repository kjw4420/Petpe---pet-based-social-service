  ...
  return (
    ...
    <div className="profileWrapper">
      ...
      <div className="profileCard">
        <img src="./img/profileImg.png" alt="프로필사진" className="profileImage"></img>
      ...
      <div className="presentpicture">
        ...
        <div className="presentGallery">
          <img src="./img/profile_img1.jpg" alt="예시사진" className="exPicture"></img>
          <img src="./img/profile_img2.jpg" alt="예시사진2" className="exPicture2"></img>
          <img src="./img/profile_img2.jpg" alt="예시사진2" className="exPicture2"></img>
          <img src="./img/profile_img2.jpg" alt="예시사진2" className="exPicture2"></img>
        </div>
      </div>
